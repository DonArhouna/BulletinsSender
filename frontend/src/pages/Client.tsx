    ...
    <div className="min-h-screen bg-slate-50">
      <header className="h-16 flex items-center justify-between px-6 sticky top-0 z-20 bg-sky-100/90 backdrop-blur border-b border-sky-200 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="h-12 w-12 bg-white/10 relative shadow-lg rounded-[50%] flex items-center justify-center" style={{ backgroundColor: "#2596be" }}>
            <img src={logo} alt="Logo" className="h-9 w-9 rounded-[50%]" />
          </div>
